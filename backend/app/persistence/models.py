...
class FarmPlot(Base):
    ...
    location_accuracy_m: Mapped[float] = mapped_column(Float, nullable=True)
    location_source: Mapped[str] = mapped_column(String(20), nullable=True)
    coordinates_updated_at: Mapped[datetime] = mapped_column(DateTime, nullable=True)
