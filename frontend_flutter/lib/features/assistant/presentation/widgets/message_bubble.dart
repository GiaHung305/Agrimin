    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: safe ? AppColors.mint : AppColors.warningSurfaceStrong,
          ...
          child: Row(
            children: [
              Icon(
                ...
                size: 16,
                color: safe ? AppColors.forest : AppColors.warning,
              ),
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: safe ? AppColors.forestDark : AppColors.warningDark,
                  ),
                ),
              ),
            ],
