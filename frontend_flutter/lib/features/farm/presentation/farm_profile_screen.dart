...
import 'package:frontend_flutter/app/home_shell.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  color: AppColors.successSurfaceStrong,
                  fontSize: 12,
                ),
              ),
            ],
...
class _Notice extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      children: [
        const Icon(Icons.wifi_off_rounded, color: AppColors.warning, size: 19),
